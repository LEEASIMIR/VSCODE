...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    subItems: [{ name: "Ecommerce", path: "/template", pro: false }],
  },
  {
    icon: <CalenderIcon />,
    name: "Calendar",
  ...
  },
  {
    name: "Forms",
    icon: <ListIcon />,
    subItems: [{ name: "Form Elements", path: "/template/form-elements", pro: false }],
  },
  {
    name: "Tables",
    icon: <TableIcon />,
    subItems: [{ name: "Basic Tables", path: "/template/basic-tables", pro: false }],
  },
  {
    name: "Pages",
    icon: <PageIcon />,
